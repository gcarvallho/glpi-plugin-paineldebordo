...
if ($sel_ent == '' || $sel_ent == -1) {
	...
	$res_ent1 = $DB->doQuery($query_ent1);
...
<head>
	<title> GLPI - <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Group', 'paineldebordo') . 's'; ?> </title>
	...
	<div id='content'>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					<div id="head-rel" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Group', 'paineldebordo') . 's'; ?> </div>
		...
		<table class='col-md-12 right' align='right' style='margin-bottom:20px;'>
				<tr>			
					<td> 
						" . __('Actor') . " : &nbsp;
						<button class='btn btn-primary btn-sm' type='button' name='requerente' value='Requerentes' onclick='location.href=\"rel_grupos.php?con=1&actor=req&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Requester', 'paineldebordo') . " </button>
						<button class='btn btn-primary btn-sm' type='button' name='tecnico' value='Técnicos' onclick='location.href=\"rel_grupos.php?con=1&actor=tec&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Technician', 'paineldebordo') . " </button>
						<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_grupos.php?con=1&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('All', 'paineldebordo') . " </button>				
					</td>
				</tr>
		</table> ";
			...
			<table id='tec' class='display' style='font-size: 13px; font-weight:bold;' cellpadding = 2px >
				<thead>
					<tr>
						...
						<th style='text-align:center; cursor:pointer;'> " . __('Late', 'paineldebordo') . "</th>
						<th style='text-align:center; cursor:pointer;'> " . __('Solved', 'paineldebordo') . "</th>	
						<th style='text-align:center; cursor:pointer;'> " . __('Closed', 'paineldebordo') . "</th>									
						<th style='text-align:center; '> % " . __('Closed', 'paineldebordo') . "</th> 

						<th style='text-align:center; '>" . __('Backlog', 'paineldebordo') . " </th>";
			...
			" . $entidade . " ";
								...
								$result_cham = $DB->doQuery($sql_cham) or die("erro_cham");
			...
			" . $entidade . " ";
								...
								$result_sol = $DB->doQuery($sql_sol) or die("erro_ab");
			...
			(
			  ...
			  OR (
			    `glpi_tickets`.`solvedate` IS NULL AND `glpi_tickets`.`time_to_resolve` < NOW()
								...
								$result_due = $DB->doQuery($sql_due) or die("erro_late");
			...
			" . $entidade . " ";
								...
								$result_clo = $DB->doQuery($sql_clo) or die("erro_ab");
			...
			AND glpi_tickets.date < '" . $data_ini . " 00:00:00' ";
								...
								$result_bac = $DB->doQuery($sql_bac) or die("erro_ab");
										...
										buttons: ["csvHtml5", "excelHtml5",
											{
												...
												message: "<?php echo  __('Period', 'paineldebordo'); ?> : <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?>"
											}
										]
									}
								]
