...
<head>
	<title> GLPI - <?php echo __('Tickets', 'paineldebordo') ?> </title>
...
<body style="background-color: #e5e5e5; margin-left:0%;">
		...
		<div id='container-fluid' style="margin: 0px 2% 0px 2%;">
			<div id="charts" class="fluid chart">
				<div id="head-lg" class="fluid" style="height: 450px;">
					...
					<div id="titulo_rel"> <?php echo __('Tickets', 'paineldebordo') ?> </div>
			...
			ORDER BY name ASC ";
								...
								<tr>
									<td style="margin-top:2px; width:100px;"><?php echo __('Due Date', 'paineldebordo'); ?>: </td>
									<td style="margin-top:2px;">
										<?php
										// lista de tipos		
										$arr_due = array();
										$arr_due[0] = "-----";
										$arr_due[1] = __('Overdue', 'paineldebordo');
										$arr_due[2] = __('Within', 'paineldebordo');
										$name = 'sel_due';
										$options = $arr_due;
										$selected = $id_due1;
	...
	<table class='fluid'  style=' width:100%; font-size: 18px; font-weight:bold;  margin-bottom:25px;  margin-top:20px; ' cellpadding = 1px>
		<td  style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> " . __('Entity', 'paineldebordo') . ": </span>" . $ent_name['cname'] . " </td>
	...
	<table id='ticket' class='display'  style='width: 99%; font-size: 11px; font-weight:bold;' cellpadding = 2px>
		<thead>
			<tr>
				...
				<th style='font-size: 12px; text-align: center; cursor:pointer;'> " . __('Opened', 'paineldebordo') . "</th>
				<th style='font-size: 12px; text-align: center; cursor:pointer;'> " . __('Closed') . " </th>
				<th style='font-size: 12px; text-align: center; cursor:pointer;'> " . __('Due Date', 'paineldebordo') . " </th>
			</tr>
		</thead>
	<tbody>";
