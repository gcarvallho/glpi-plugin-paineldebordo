...
<head>
	<title> GLPI - <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by OLAs', 'paineldebordo') ?> </title>
			...
			<table id='sla' class='display'  style='font-size: 12px; font-weight:bold;' cellpadding = 2px>
				<thead>
					<tr>
						...
						<th style='text-align:center; cursor:pointer;'> " . __('Within', 'paineldebordo') . "</th>							
					</tr>
				</thead>
			<tbody> ";
