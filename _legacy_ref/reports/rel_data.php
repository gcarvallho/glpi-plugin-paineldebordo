...
<head>
	<title> GLPI - <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Date', 'paineldebordo') ?> </title>
...
<body style="background-color: #e5e5e5;">
	...
	<div id='content'>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					...
					<div id="head-rel" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Date', 'paineldebordo') ?> </div>
								...
								<table border="0" cellspacing="0" cellpadding="3" bgcolor="#efefef">
									<tr>
										...
										<td style="margin-top:2px;">
											...
											$arr_date = array(
												__('----'),
												__('Today', 'paineldebordo'),
												__('Yesterday', 'paineldebordo'),
												__('Last 7 days', 'paineldebordo'),
												__('Last 15 days', 'paineldebordo'),
												__('Last 30 days', 'paineldebordo'),
												__('Last 3 months', 'paineldebordo'),
											);
		...
		" . $entidade . " ";
					...
					$result_cham2 = $DB->doQuery($sql_cham2);
		...
		<table class='col-md-12 col-sm-12 fluid'  style='font-size: 18px; font-weight:bold;' cellpadding = 1px>
			<td colspan='2' style='font-size: 18px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> " . __('Tickets', 'paineldebordo') . ":</span> " . $total_cham . " </td>
		...
		<table align='right' style='margin-bottom:10px;'>
			<tr>
				<td colspan='3'>
					<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_data.php?con=1&stat=open&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Opened', 'paineldebordo') . "</button>
					<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_data.php?con=1&stat=close&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " .  __('Closed', 'paineldebordo') . " </button>
					<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_data.php?con=1&stat=all&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('All', 'paineldebordo') . " </button>
			</tr>
		</table>
									...
									buttons: [{
										...
										},
										{
											...
											buttons: [{
													...
													message: "<div id='print' class='info_box fluid span12' style='margin-bottom:25px; margin-left: -1px;'><table id='print_tb' class='fluid'  style='width: 80%; margin-left: 20%; font-size: 18px; font-weight:bold;' cellpadding = '1px'><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo  __('Tickets', 'paineldebordo'); ?> : </span><?php echo $total_cham; ?></td><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle; width:200px;'><span style='color:#000;'> <?php echo  __('Period', 'paineldebordo'); ?> : </span> <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?> </td> </table></div>",
												},
												{
													extend: "print",
													autoPrint: true,
