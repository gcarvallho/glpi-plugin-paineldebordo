...
<head>
	<title> GLPI - <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Location', 'paineldebordo') ?> </title>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					<div id="head-rel" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Location', 'paineldebordo') ?> </div>
...
<tr>
		...
		<td style='font-size: 16px; font-weight:bold; vertical-align:middle; width:230px;'><span style='color:#000;'>" . __('Period', 'paineldebordo') . ": </span> " . conv_data($data_ini2) . " a " . conv_data($data_fin2) . "</td>
...
<table align='right' style='margin-bottom:3px;'>
		<tr>
			<td colspan=3>
				<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_localidade.php?con=1&stat=open&sel_loc=" . $id_loc . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Opened', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_localidade.php?con=1&stat=close&sel_loc=" . $id_loc . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Closed', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_localidade.php?con=1&stat=all&sel_loc=" . $id_loc . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('All', 'paineldebordo') . " </button>
			</td>
		</tr>
</table>
												...
												buttons: ["csvHtml5", "excelHtml5",
													{
														...
														message: "<?php echo __('Location'); ?> : <?php echo $ent_name['name'] . '  -  '; ?>  <?php echo  __('Tickets', 'paineldebordo'); ?> : <?php echo $consulta . '  -  '; ?> <?php echo  __('Period', 'paineldebordo'); ?> : <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?>",
													}
												]
											}
										]
