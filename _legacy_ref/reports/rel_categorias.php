...
<body style="background-color: #e5e5e5;">
	...
	<div id='content'>
								...
								<table border="0" cellspacing="0" cellpadding="3" bgcolor="#efefef">
									...
									<tr>
										<td colspan="2" align="center">
											...
											<button class="btn btn-primary btn-sm" type="button" name="Limpar" value="Limpar" onclick="location.href='<?php echo $url2 . '?con=1'; ?>'"><i class="fa fa-trash-o"></i>&nbsp; <?php echo __('Clean', 'paineldebordo'); ?> </button>
										</td>
									</tr>
		...
		ORDER BY total DESC ";
						...
						if ($sel_ent != 0) {
							echo "<span style='font-size: 16px; font-weight:bold; vertical-align:middle; margin-bottom:20px;'><span style='color:#000;'> " . __('Entity', 'paineldebordo') . ": </span>" . $ent_name['name'] . " </span>\n";
						}
			...
			<tbody>\n ";
				...
				" . $entidade . " ";
							...
							$result_fech = $DB->doQuery($sql_fech);
