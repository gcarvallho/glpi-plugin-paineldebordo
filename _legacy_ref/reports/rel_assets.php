				...
				<select id='sel_item' name='sel_item' style='width: 300px; height: 27px;' autofocus onChange=\"ajaxComboBox('manufac.php','sel_fab');\">
									...
									<tr>
										...
										<td style="margin-top:5px;">
											...
											<select name="sel_fab" id="sel_fab" class="sel_fab" style="width: 300px; height: 27px;" autofocus onChange="ajaxComboBox2('model.php','sel_mod');">
												<option value="0"><?php echo __('Select a type', 'paineldebordo'); ?></option>
											</select>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td style="margin-top:2px;">
											<select name="sel_mod" id="sel_mod" class="sel_mod" style="width: 300px; height: 27px;" autofocus>
												<option value="0"><?php echo __('Select a manufacturer', 'paineldebordo'); ?></option>
											</select>
										</td>
									</tr>
					...
					if ($con == "1") {
						...
						if (isset($_REQUEST["sel_mod"]) && $_REQUEST["sel_mod"] != '0') {
							if ($_REQUEST["sel_mod"] != '') {
								$id_mod = $_REQUEST["sel_mod"];
								$model = "AND " . $type . "models_id = " . $id_mod . "";
							}
						} else {
							$id_mod = '';
							$model = '';
...
<table class='fluid'  style='margin-bottom: 25px; font-size: 18px; font-weight:bold; width:100%;' cellpadding = 1px >
	...
	<td  style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> " . __('Quantity', 'paineldebordo') . ": </span>" . $consulta . " </td>
...
<table id='asset' class='display'  style='font-size: 12px; font-weight:bold;' cellpadding = 2px>
	<thead>
		<tr>
			...
			<th style='text-align:center; font-size: 12px; font-weight:bold; cursor:pointer; text-align:center;'> " . __('Tickets', 'paineldebordo') . " </th>
		</tr>
	</thead>
<tbody>";
					...
					AND date " . $datas2 . " ";
								...
								$result_count = $DB->doQuery($sql_count);
										...
										buttons: [{
											...
											},
											{
												...
												buttons: [{
														...
														message: "<div id='print' class='info_box fluid span12' style='margin-bottom:35px; margin-left: -1px;'><table id='print_tb' id='print_tb' class='fluid'  style='width: 80%; margin-left: 10%; font-size: 18px; font-weight:bold;' cellpadding = '1px'><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo __('Type'); ?> : </span><?php echo __($typeuc); ?> </td><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo __('Manufacturer'); ?> : </span><?php echo $fab['name']; ?> </td> <td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo  __('Quantity', 'paineldebordo'); ?> : </span><?php echo $consulta; ?></td><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle; width:200px;'><span style='color:#000;'> <?php echo  __('Period', 'paineldebordo'); ?> : </span> <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?> </td> </table></div>",
													},
													{
														extend: "print",
														autoPrint: true,
