      ...
      <page_footer align='center'>
 		...
 		<!-- <div class='fluid col-md-12 report' style='margin-left: 0px; margin-top: -8px;'> -->		
			 ...
			 <div id='logo' class='fluid'>
			 	...
			 	<span class='col-md-8' style='margin-top:-80px; height:60px; text-align:center; margin:auto;'><h3 style='vertical-align:top;'>" . __('Summary Report', 'paineldebordo') . " </h3></span>
			 </div>
			 ...
			 <tbody>				
			 <tr>
			 <td width='300'>" . __('Period', 'paineldebordo') . ": </td>";
			...
			$content .= "					
			 ...
			 <tbody>			
			 <tr>
			 <td width='300'>" . __('Tickets Total', 'paineldebordo') . "</td>
