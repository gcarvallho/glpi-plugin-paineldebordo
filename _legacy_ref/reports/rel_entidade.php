...
<head>
	<title> GLPI - <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Entity', 'paineldebordo') ?> </title>
...
<body style="background-color: #e5e5e5; margin-left:0%;">
	...
	<div id='content'>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					<div id="head-lg" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Entity', 'paineldebordo') ?> </div>
								...
								<table border="0" cellspacing="0" cellpadding="3" bgcolor="#efefef">
									<tr>
										...
										ORDER BY `name` ASC ";
											...
											$result_ent = $DB->doQuery($sql_ent);

											$arr_ent = array();
											$arr_ent[-1] = "-- " . __('Select a entity', 'paineldebordo') . " --";
											$arr_ent[0] = __('All');
		...
		<table class='fluid'  style='width:100%; font-size: 18px; font-weight:bold;' cellpadding = '1px'>
			<tr>
				<td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> " . __('Entity', 'paineldebordo') . ": </span>" . $ent_name['name'] . " </td>
			</tr>
			<tr>
				<td style='font-size: 16px; font-weight:bold; vertical-align:middle; width:180px;'><span style='color:#000;'> " . __('Tickets', 'paineldebordo') . ": </span>" . $consulta . " </td>
		...
		<table align='right' style='margin-bottom:10px;'>
			<tr>
				<td>
					<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_entidade.php?con=1&stat=open&sel_ent=" . $id_ent . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Opened', 'paineldebordo') . " </button>
					<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_entidade.php?con=1&stat=close&sel_ent=" . $id_ent . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Closed', 'paineldebordo') . " </button>
					<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_entidade.php?con=1&stat=all&sel_ent=" . $id_ent . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('All', 'paineldebordo') . " </button>
				</td>
			</tr>
		</table>
		...
		<table style='font-size: 16px; width: 50%;' border=0>
			<tr>
				...
				<td style='font-weight:bold;'><span style='color: #000;'>" . __('Solved', 'paineldebordo') . ": </span>" . $solve . " </td>
		...
		<table id='t_ent' class='display' style='font-size: 11px;' >
			<thead>
				<tr>
					<th style='font-size: 12px; font-weight:bold; text-align: center; cursor:pointer;'> " . __('Tickets', 'paineldebordo') . " </th>
					...
					<th style='font-size: 12px; font-weight:bold; text-align: center; cursor:pointer;'> " . __('Opened', 'paineldebordo') . "</th>
					<th style='font-size: 12px; font-weight:bold; text-align: center; cursor:pointer;'> " . __('Closed', 'paineldebordo') . " </th>
		...
		";
				...
				WHERE glpi_items_tickets.tickets_id = " . $row['id'] . "";
								...
								$result_item = $DB->doQuery($sql_item);
				...
				AND glpi_tickets.`requesttypes_id` = glpi_requesttypes.id";
								...
								$result_source = $DB->doQuery($sql_source);
								...
								$(document).ready(function() {
									$('#t_ent').DataTable({
										...
										buttons: [{
												...
												buttons: ["csvHtml5", "excelHtml5",
													{
														...
														message: "<?php echo __('Entity', 'paineldebordo'); ?> : <?php echo $ent_name['name'] . '  -  '; ?> <?php echo  __('Tickets', 'paineldebordo'); ?> : <?php echo $consulta . '  -  '; ?> <?php echo  __('Period', 'paineldebordo'); ?> : <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?> ",
														exportOptions: {
															columns: ':visible'
														}
													}
											...
											{
												extend: 'colvis',
												text: "<?php echo __('Show/hide columns', 'paineldebordo'); ?>",
