...
<head>
	<title> GLPI - <?php echo __('Cost') . '  ' . __('by Location', 'paineldebordo') ?> </title>
...
<body style="background-color: #e5e5e5; margin-left:0%;">
	...
	<div id='content'>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					<div id="head-rel" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Cost') . '  ' . __('by Location', 'paineldebordo') ?> </div>
		...
		ORDER BY `name` ASC ";
											...
											$arr_loc = array();
											$arr_loc[0] = "-- " . __('Select a location', 'paineldebordo') . " --";
			...
			WHERE id = " . $row_result['ent'] . " ";
					...
					if (isset($_GET['con'])) {
						...
						if ($con == "1") {
							...
							if ($id_loc == 0) {
								echo '<script language="javascript"> alert(" ' . __('Select a location', 'paineldebordo') . ' "); </script>';
	...
	<table class='fluid'  style='font-size: 18px; font-weight:bold; width:100%;' cellpadding = '1px'>
		...
		<tr>	
			...
			<td colspan='1' style='font-size: 18px; font-weight:bold; vertical-align:middle;'><span style='font-size: 18px; color:#000;'>" . __('Period', 'paineldebordo') . ": </span> " . conv_data($data_ini2) . " a " . conv_data($data_fin2) . "
	...
	<table align='right' style='margin-bottom:10px;'>
		<tr>
			<td colspan=3 style='vertical-align:bottom;'>
				<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_custo_loc.php?con=1&stat=open&sel_loc=" . $id_loc . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Opened', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_custo_loc.php?con=1&stat=close&sel_loc=" . $id_loc . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Closed', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_custo_loc.php?con=1&stat=all&sel_loc=" . $id_loc . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('All', 'paineldebordo') . " </button>
			</td>
		</tr>
	</table>
													...
													buttons: ["csvHtml5", "excelHtml5",
														{
															...
															message: "<?php echo __('Location'); ?> : <?php echo $ent_name . ' - '; ?> <?php echo  __('Tickets', 'paineldebordo'); ?> : <?php echo $conta_cons . '  - '; ?>  <?php echo  __('Total cost'); ?> : <?php echo number_format($total_cost, 2, ',', ' ') . ' - '; ?> <?php echo  __('Period', 'paineldebordo'); ?> : <?php echo conv_data($data_ini2); ?> - <?php echo conv_data($data_fin2); ?>"
														}
													]
												}
											]
