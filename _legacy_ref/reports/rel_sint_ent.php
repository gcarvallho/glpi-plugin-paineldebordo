...
<head>
	<title> GLPI - <?php echo __('Summary Report', 'paineldebordo') . " - " . __('Entity') ?> </title>
...
<body style="background-color: #e5e5e5;">
	<div id='content'>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					<div id="head-rel" class="fluid head-rel-sint">
						...
						<div id="titulo_rel"> <?php echo __('Summary Report', 'paineldebordo') . ' - ' . __('Entity'); ?> </div>
								...
								<table border="0" cellspacing="0" cellpadding="3" bgcolor="#efefef">
									<tr>
										...
										<td style="margin-top:2px;">
											...
											$arr_date = array(
												__('Select', 'paineldebordo'),
												__('Current month', 'paineldebordo'),
		...
		ORDER BY `cname` ASC ";
					...
					$result_entname = $DB->doQuery($sql_entname);
		...
		" . $entidade . " ";
			...
			" . $entidade . " ";
						...
						$result_time = $DB->doQuery($sql_time);
		...
		<div class='well info_box fluid col-md-12 report-tic' style='margin-left: -1px;'>	
			 ...
			 <div id='logo' class='fluid'>
				 ...
				 <div class='col-md-8' style='height:120px; text-align:center; margin:auto;'><h3 style='vertical-align:middle;' >" . __('Summary Report', 'paineldebordo') . " - " . __('Entity') . " </h3></div>
			 </div>
			 ...
			 <thead>
			 <tr>
			 <th colspan='2' style='text-align:center; background:#286090; color:#fff;'>" . __('Tickets', 'paineldebordo') . "</th>						
			 </tr>
			 </thead>	

			 <tbody>			
			 <tr>
			 <td>" . __('Tickets Total', 'paineldebordo') . "</td>
			 ...
			 <tr>
			 <td>" . __('Tickets', 'paineldebordo') . " " . __('By day') . " - " . __('Average') . "</td>
			 ...
			 <thead>
			 <tr>
			 <th colspan='2' style='text-align:center; background:#286090; color:#fff;'>" . __('Tickets by Status', 'paineldebordo') . "</th>						
			 </tr>
			 </thead>	
			 ...
			 <thead>
			 <tr>
			 <th colspan='2' style='text-align:center; background:#286090; color:#fff;'>" . __('Tickets', 'paineldebordo') . " " . __('by Type', 'paineldebordo') . "</th>						
			 </tr>
			 </thead>	
			 ...
			 <thead>
			 <tr>
			 <th colspan='2' style='text-align:center; background:#286090; color:#fff;'>Top 5 - " . __('Tickets', 'paineldebordo') . " " . __('by Group', 'paineldebordo') . "</th>						
			 </tr>
			 </thead>	
			 ...
			 <thead>
			 <tr>
			 <th colspan='2' style='text-align:center; background:#286090; color:#fff;'>Top 5 - " . __('Tickets', 'paineldebordo') . " " . __('by Technician', 'paineldebordo') . "</th>						
			 </tr>
			 </thead>	
			 ...
			 <thead>
			 <tr>
			 <th colspan='2' style='text-align:center; background:#286090; color:#fff;'>Top 5 - " . __('Tickets', 'paineldebordo') . " " . __('by Requester', 'paineldebordo') . "</th>						
			 </tr>
			 </thead>	
