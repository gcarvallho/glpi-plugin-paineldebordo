...
<head>
	<title> GLPI - <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Requester', 'paineldebordo') ?> </title>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					<div id="head-rel" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Requester', 'paineldebordo') ?> </div>
...
" . $entidade_u . " ";
   ...
   AND glpi_tickets.date " . $datas2 . " 
	...
	<tr>
		...
		<td style='vertical-align:middle;'> <span style='color: #000;'>" . __('Tickets', 'paineldebordo') . ": </span>" . $conta_cons . "</td>
		<td colspan='3' style='font-size: 16px; font-weight:bold; vertical-align:middle; width:200px;'><span style='color:#000; font-size: 18px;'>" . __('Period', 'paineldebordo') . ": </span> " . conv_data($data_ini2) . " a " . conv_data($data_fin2) . "
		</td>
	...
	<table align='right' style='margin-bottom:10px;'>
		<tr>
			<td>
				<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_usuario.php?con=1&stat=open&sel_tec=" . $id_tec . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Opened', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_usuario.php?con=1&stat=close&sel_tec=" . $id_tec . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Closed', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_usuario.php?con=1&stat=all&sel_tec=" . $id_tec . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('All', 'paineldebordo') . " </button>
			</td>
		</tr>
	</table>
	...
	<table id='users' class='display' style='font-size: 13px; font-weight:bold;' cellpadding = 2px>
		<thead>
			<tr>
				...
				<th style='text-align:center; cursor:pointer;'> " . __('Status', 'paineldebordo') . " </th>
										...
										buttons: [{
											...
											},
											{
												...
												buttons: [{
														...
														message: "<div id='print' class='info_box fluid span12' style='margin-bottom:35px; margin-left: -1px;'><table id='print_tb' class='fluid' style='width: 80%; margin-left: 10%; font-size: 18px; font-weight:bold;' cellpadding = '1px'><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo __('Requester', 'paineldebordo'); ?> : </span><?php echo $user; ?> </td> <td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo  __('Tickets', 'paineldebordo'); ?> : </span><?php echo $consulta; ?></td><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle; width:200px;'><span style='color:#000;'> <?php echo  __('Period', 'paineldebordo'); ?> : </span> <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?> </td> </table></div>",
													},
													{
														extend: "print",
														autoPrint: true,
												...
												buttons: ["csvHtml5", "excelHtml5",
													{
														...
														message: "<?php echo __('Requester', 'paineldebordo'); ?> : <?php echo $user . '  - '; ?> <?php echo  __('Tickets', 'paineldebordo'); ?> : <?php echo $consulta . '  - '; ?> <?php echo  __('Period', 'paineldebordo'); ?> : <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?>",
													}
												]
											}
										]
