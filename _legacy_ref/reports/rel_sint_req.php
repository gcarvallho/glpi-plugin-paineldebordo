...
<head>
	<title> GLPI - <?php echo  __('Summary Report', 'paineldebordo') . " - " . __('Requester') ?> </title>
	...
	<div id='content'>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					...
					<div id="head-lg" class="fluid head-rel-sint">
						...
						<div id="titulo_rel"> <?php echo __('Summary Report', 'paineldebordo') . " - " . __('Requester') ?> </div>
		...
		<div class='well info_box fluid col-md-12 report-tic' style='margin-left: -1px;'>	
			 ...
			 <div id='logo' class='fluid'>
				 ...
				 <div class='col-md-8' style='height:120px; text-align:center; margin:auto;'><h3 style='vertical-align:middle;' >" . __('Summary Report', 'paineldebordo') . " - " . __('Requester') . " </h3></div>
			 </div>
