...
<head>
	<title> GLPI - <?php echo  __('Summary Report', 'paineldebordo') . " - " . __('Technician') ?> </title>
	...
	<div id='content'>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					...
					<div id="head-rel" class="fluid head-rel-sint">
						...
						<div id="titulo_rel"> <?php echo __('Summary Report', 'paineldebordo') . " - " . __('Technician') ?> </div>
								...
								<table border="0" cellspacing="0" cellpadding="3" bgcolor="#efefef">
									<tr>
										...
										<td style="margin-top:2px;">
											...
											//$res_date = $DB->doQuery($sql_date);
											$arr_date = array(
												__('Period', 'paineldebordo'),
		...
		" . $entidade . " ";
			...
			LIMIT 5 ";
						...
						$result_cat = $DB->doQuery($query_cat) or die('erro');
		...
		<div class='well info_box fluid col-md-12 report-tic' style='margin-left: -1px;'>	
			 ...
			 <div id='logo' class='fluid'>
				 ...
				 <div class='col-md-8' style='height:120px; text-align:center; margin:auto;'><h3 style='vertical-align:middle;' >" . __('Summary Report', 'paineldebordo') . " - " . __('Technician') . " </h3></div>
			 </div>
			 ...
			 <thead>
			 <tr>
			 <th colspan='2' style='text-align:center; background:#286090; color:#fff;'>Top 5 - " . __('Tickets', 'paineldebordo') . " " . __('by Category', 'paineldebordo') . "</th>						
			 </tr>
			 </thead>	
