...
<head>
	<title> GLPI - <?php echo __('Summary Report', 'paineldebordo') ?> </title>
	...
	<div id='content'>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					...
					<div id="head-rel" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Summary Report', 'paineldebordo') . '  ' . __('', 'paineldebordo') ?> </div>
		...
		<div class='well info_box fluid col-md-12 report' style='margin-left: -1px;'>	
			 ...
			 <div id='logo' class='fluid'>
				 ...
				 <div class='col-md-8' style='height:120px; text-align:center; margin:auto;'><h3 style='vertical-align:middle;' >" . __('Summary Report', 'paineldebordo') . " </h3></div>
			 </div>
