...
<head>
	<title> GLPI - <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Category', 'paineldebordo') ?> </title>
		...
		<div id='container-fluid' style="margin: <?php echo margins(); ?> ;">
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					<div id="head-lg" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Tickets', 'paineldebordo') . '  ' . __('by Category', 'paineldebordo') ?> </div>
								...
								<table border="0" cellspacing="0" cellpadding="3" bgcolor="#efefef" width="810">
									<tr>
										...
										ORDER BY `name` ASC ";
											...
											$arr_cat = array();
											$arr_cat[0] = "-- " . __('Select a category', 'paineldebordo') . " --";
										...
										<td style="width: 300px; padding-left: 15px; text-align: left;">
											<input type="checkbox" name="sons" value="1"> <?php echo __('Sons', 'paineldebordo'); ?>
										</td>

									</tr>
									<tr>
										<td height="10px" colspan="1"></td>
									</tr>
									<tr>
					...
					if ($con == "1") {
						...
						if ($sons_cat == 1) {
							...
							$and_sons = " (+ " . __('Sons', 'paineldebordo') . ")";
						} else {
							$id_cat_name = $id_cat;
						}
			...
			<table class='col-md-12 col-sm-12 fluid'  style='font-size: 18px; font-weight:bold;' cellpadding = 1px>
				<tr>
					...
					<td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle; width:200px;'><span style='color:#000;'>" . __('Period', 'paineldebordo') . ": </span> " . conv_data($data_ini2) . " a " . conv_data($data_fin2) . " </td>
			...
			<table align='right' style='margin-bottom:10px; border=1'>
				<tr>
					<td colspan='3'>
						<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_categoria.php?con=1&stat=open&cat=" . $id_cat . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Opened', 'paineldebordo') . " </button>
						<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_categoria.php?con=1&stat=close&cat=" . $id_cat . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Closed', 'paineldebordo') . " </button>
						<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_categoria.php?con=1&stat=all&cat=" . $id_cat . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('All', 'paineldebordo') . " </button>
					</td>
				</tr>
			</table>
										...
										buttons: [{
											...
											},
											{
												...
												buttons: [{
														...
														message: "<div id='print' class='info_box fluid col-md-12 col-sm-12' style='margin-bottom:35px; margin-left: -1px;'><table id='print_tb' class='fluid'  style='width: 80%; margin-left: 10%; font-size: 18px; font-weight:bold;' cellpadding = '1px'><tr><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo __('Category'); ?> : </span><?php echo $cat_name['name']; ?> </td></tr><tr><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo  __('Tickets', 'paineldebordo'); ?> : </span><?php echo $consulta; ?></td><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle; width:200px;'><span style='color:#000;'> <?php echo  __('Period', 'paineldebordo'); ?> : </span> <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?> </td></tr></table></div>",
													},
													{
														extend: "print",
														autoPrint: true,
												...
												buttons: ["csvHtml5", "excelHtml5",
													{
														...
														message: "<?php echo __('Category'); ?> : <?php echo $cat_name['name'] . '  -  '; ?> <?php echo  __('Tickets', 'paineldebordo'); ?> : <?php echo $consulta . '  -  '; ?> <?php echo  __('Period', 'paineldebordo'); ?> : <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?>",
													}
												]
											}
										]
