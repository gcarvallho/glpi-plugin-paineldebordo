...
<head>
	<title> GLPI - <?php echo __('Cost') . '  ' . __('by Requester', 'paineldebordo') ?> </title>
...
ORDER BY name ASC ";
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					<div id="head-rel" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Cost') . '  ' . __('by Requester', 'paineldebordo') ?> </div>
								...
								<tr>
									...
									<td>&nbsp;</td>
										...
										<td style="margin-top:2px;">
											...
											$arr_tec = array();
											$arr_tec[0] = "-- " . __('Select a requester', 'paineldebordo') . " --";
					...
					if (isset($_GET['con'])) {
						...
						if ($con == "1") {
							...
							if ($id_tec == 0) {
								echo '<script language="javascript"> alert(" ' . __('Select a requester', 'paineldebordo') . ' "); </script>';
	...
	<table class='fluid'  style='font-size: 18px; font-weight:bold; width:100%;' cellpadding = 1px border='0'>
		<tr style='width: 450px;'>
			<td style='vertical-align:middle;'> <span style='color: #000;'>" . __('Requester', 'paineldebordo') . ": </span>" . $row['firstname'] . " " . $row['realname'] . "</td>
			<td style='vertical-align:middle;' class='left' colspan=2> <span style='color: #000;'>" . __('Tickets', 'paineldebordo') . ": </span>" . $conta_cons . "</td>
	...
	$result_cost = $DB->doQuery($query_cost);
	...
	<table align='right' style='margin-bottom:10px;'>
		<tr>
			<td colspan=3 style='vertical-align:bottom;'>
				<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_custo_req.php?con=1&stat=open&sel_tec=" . $id_tec . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Opened', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_custo_req.php?con=1&stat=close&sel_tec=" . $id_tec . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Closed', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_custo_req.php?con=1&stat=all&sel_tec=" . $id_tec . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('All', 'paineldebordo') . " </button>
			</td>
		</tr>
	</table>
	...
	<table id='tec' class='display' style='font-size: 13px; font-weight:bold;' cellpadding = 2px >
		<thead>
			<tr>
				<th style='text-align:center; cursor:pointer; vertical-align:middle;'> " . __('Tickets', 'paineldebordo') . " </th>
	...
	AND glpi_tickets_users.type = 2 ";
											...
											buttons: [{
												...
												},
												{
													...
													buttons: [{
															...
															message: "<div id='print' class='fluid span12' style='margin-bottom: 25px; margin-left: -1px;'><table id='print_tb' class='fluid'  style='width: 80%; margin-left: 10%; font-size: 18px; font-weight:bold;' cellpadding = '1px'><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo __('Requester', 'paineldebordo'); ?> : </span><?php echo $tech; ?> </td> <td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo  __('Tickets', 'paineldebordo'); ?> : </span><?php echo $conta_cons; ?></td><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle; width:200px;'><span style='color:#000;'> <?php echo  __('Period', 'paineldebordo'); ?> : </span> <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?> </td></tr> <tr><td>&nbsp;</td></tr> <tr><td style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo  __('Total cost'); ?> : </span><?php echo number_format($total_cost, 2, ',', ' '); ?></td></tr> </table></div>",
														},
														{
															extend: "print",
															autoPrint: true,
													...
													buttons: ["csvHtml5", "excelHtml5",
														{
															...
															message: "<?php echo __('Requester', 'paineldebordo'); ?> : <?php echo $tech . '  - '; ?> <?php echo  __('Tickets', 'paineldebordo'); ?> : <?php echo $conta_cons . '  - '; ?>  <?php echo  __('Total cost'); ?> : <?php echo number_format($total_cost, 2, ',', ' ') . ' - '; ?> <?php echo  __('Period', 'paineldebordo'); ?> : <?php echo conv_data($data_ini2); ?> - <?php echo conv_data($data_fin2); ?>"
														}
													]
												}
											]
		...
		<tr><td style='vertical-align:middle; text-align:center;'> <span style='color: #000;'>" . __('No ticket found', 'paineldebordo') . "</td></tr>
		<tr></tr>
		</table></div>";
							}
						}
