...
<head>
	<title> GLPI - <?php echo __('Cost') . '  ' . __('by Technician', 'paineldebordo') ?> </title>
			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					<div id="head-rel" class="fluid">
						...
						<div id="titulo_rel"> <?php echo __('Cost') . '  ' . __('by Technician', 'paineldebordo') ?> </div>
	...
	<table align='right' style='margin-bottom:10px;'>
		<tr>
			<td colspan=3 style='vertical-align:bottom;'>
				<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_custo_tec.php?con=1&stat=open&sel_tec=" . $id_tec . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Opened', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_custo_tec.php?con=1&stat=close&sel_tec=" . $id_tec . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('Closed', 'paineldebordo') . " </button>
				<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_custo_tec.php?con=1&stat=all&sel_tec=" . $id_tec . "&date1=" . $data_ini2 . "&date2=" . $data_fin2 . "\"' <i class='icon-white icon-trash'></i> " . __('All', 'paineldebordo') . " </button>
			</td>
		</tr>
	</table>
													...
													buttons: ["csvHtml5", "excelHtml5",
														{
															...
															message: "<?php echo __('Technician', 'paineldebordo'); ?> : <?php echo $tech . '  - '; ?> <?php echo  __('Tickets', 'paineldebordo'); ?> : <?php echo $conta_cons . '  - '; ?>  <?php echo  __('Total cost'); ?> : <?php echo number_format($total_cost, 2, ',', ' ') . ' - '; ?> <?php echo  __('Period', 'paineldebordo'); ?> : <?php echo conv_data($data_ini2); ?> - <?php echo conv_data($data_fin2); ?>"
														}
													]
												}
											]
