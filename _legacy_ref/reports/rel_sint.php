			...
			<div id="pad-wrapper">
				<div id="charts" class="fluid chart">
					<div id="head-rel" class="fluid">
						...
						<div id="titulo"> <?php echo __('Summary Report', 'paineldebordo') . '  ' . __('', 'paineldebordo') ?> </div>
									...
									<tr>
										...
										<td style="margin-top:2px;">
											...
											<select id='sel_rel' name='sel_rel' style='width: 300px; height: 27px;' autofocus onChange=\"javascript: document.form1.submit.focus();\"  >
												<option value='0'> -- " . __('Select', 'paineldebordo') . " -- </option>
												<option value='1'>" . __('Overall', 'paineldebordo') . "</option>
					...
					if (isset($_REQUEST["sel_rel"]) and $_REQUEST["sel_rel"] != 0) {
						...
						switch ($id_rel) {
							case "0":
								...
								break;
							case "1":
								$page = 'rel_sint_all.php';
								break;
							case "2":
								$page = 'rel_sint_ent.php';
								break;
							case "3":
								$page = 'rel_sint_tec.php';
								break;
							case "4":
								$page = 'rel_sint_req.php';
								break;
						}
				...
				<script type='text/javascript' >
					location.href='" . $page . "';
						...
						echo '<script language="javascript"> alert(" ' . __('Select', 'paineldebordo') . ' "); </script>';
