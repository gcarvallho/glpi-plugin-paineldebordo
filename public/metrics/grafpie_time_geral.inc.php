...
$(function () {		
        ...
        $('#cf-pie-1').highcharts({
            ...
            series: [{
                ...
                data: [  {
                        name: '< 1 " . __('day', 'paineldebordo') . "',
                        y: " . $arr_days[0] . ",
                        sliced: false,
                        selected: false
                    }, ['1 - 2 " . __('days', 'paineldebordo') . "',  " . $arr_days[1] . " ], ['2 - 3 " . __('days', 'paineldebordo') . "',  " . $arr_days[2] . " ],
                			['3 - 4 " . __('days', 'paineldebordo') . "', " . $arr_days[3] . " ], ['4 - 5 " . __('days', 'paineldebordo') . "',  " . $arr_days[4] . " ], 
                			['5 - 6 " . __('days', 'paineldebordo') . "',  " . $arr_days[5] . " ], ['6 - 7 " . __('days', 'paineldebordo') . "',  " . $arr_days[6] . " ],	
							['7 - 8 " . __('days', 'paineldebordo') . "',  " . $till[7] . " ], ['8 - 9 " . __('days', 'paineldebordo') . "',  " . $till[8] . " ], 
							['9 - 10 " . __('days', 'paineldebordo') . "',  " . $till[9] . " ], ['> 10 " . __('days', 'paineldebordo') . "',  " . $resto . " ],]
            }]
        });
    });
