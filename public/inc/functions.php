...
function conv_data($data)
{
   if ($data != "") {
      ...
      switch ($_SESSION['glpidate_format']) {
         case "0":
            $dataf = $date->format('Y-m-d');
            break;
         case "1":
            $dataf = $date->format('d-m-Y');
            break;
         case "2":
            $dataf = $date->format('m-d-Y');
            break;
      }
      return $dataf;
   } else {
...
function conv_data_hora($data)
{
   if ($data != "") {
      ...
      switch ($_SESSION['glpidate_format']) {
         case "0":
            $dataf = $date->format('Y-m-d H:i');
            break;
         case "1":
            $dataf = $date->format('d-m-Y H:i');
            break;
         case "2":
            $dataf = $date->format('m-d-Y H:i');
            break;
      }
