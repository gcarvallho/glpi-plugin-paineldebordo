...
$query_u = "
INSERT IGNORE INTO glpi_plugin_paineldebordo_notify (users_id, quant, type) 
VALUES ('" . $_SESSION['glpiID'] . "', '" . $init . "', '0' )  ";

$result_u = $DB->doQuery($query_u);


$query = "SELECT users_id, quant, type 
FROM glpi_plugin_paineldebordo_notify
...
$resultf = $DB->doQuery($queryn);

//$resultan = $DB->doQuery($queryn);
