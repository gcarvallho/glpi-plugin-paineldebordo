...
if (!function_exists('plugin_paineldebordo_sqlGroupScope')) {
	include_once(Plugin::getPhpDir('paineldebordo') . '/inc/access.inc.php');
}
$group_scope = plugin_paineldebordo_sqlGroupScope('glpi_groups_tickets.groups_id');
