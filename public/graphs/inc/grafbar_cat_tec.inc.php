...
$result_ent = $DB->doQuery($sql_ent) or die('erro');
...
$result4 = $DB->doQuery($query4) or die('erro');
...
$grf_4 = json_encode($grf4);
$quant_t = implode(',', $quant4);
...
$(function () {
        $('#grafcat_tec').highcharts({
            ...
            title: {
                text: '" . __('by Technician', 'paineldebordo') . "'
            },
