...
$result_if = $DB->doQuery($query_if) or die('erro');
...
//    });
		...
		echo           "height: 460
            ...
            title: {
                text: '" . __('Satisfaction', 'paineldebordo') . " - " . __('Tickets', 'paineldebordo') . "'
            },
            legend: {
                layout: 'horizontal',
                align: 'center',
		...
		if (array_sum($quantsat) != 0) {
			...
			echo  "
					{ // satisfacao
                name: '" . __('Satisfaction', 'paineldebordo') . "',
                color: '#C4D9F1',
                type: 'column',
                yAxis: 1,
		...
		echo "
                ...
                {
                name: '" . __('Closed', 'paineldebordo') . "',
                color: '#89A54E',
                data: [$quantf2]
                },

                {
                name: '" . __('Late', 'paineldebordo') . "',
                color: '#800000',
                dataLabels: {
                    enabled: true,
                    //color: '#800000',
