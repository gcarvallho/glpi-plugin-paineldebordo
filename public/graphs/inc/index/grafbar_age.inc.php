...
$(function () {
        $('#graf8').highcharts({
            ...
            title: {
                //text: '" . __('Open Tickets Age', 'paineldebordo') . "'
                text: ''
            },
