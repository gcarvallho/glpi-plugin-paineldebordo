<?php
/**
 * View: open tickets where the logged-in user (or one of their groups) is observer.
 */
...
$data = plugin_paineldebordo_tickets_open_list(null, null, 200, null, null, [], $uid);
...
$list_page = 'observer';
$list_title = __('Observer', 'paineldebordo');
$list_extra = [];
?>
