...
/**
 * Public TV pairing API (create / poll) — lives next to tv_pair.php so GLPI
 * Firewall NO_CHECK matches the same way as the pairing page (ajax/ can fall
 * through to AUTHENTICATED and return HTML 403).
 */
